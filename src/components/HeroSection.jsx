  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 md:px-12">
      ...
      <div className="z-10 flex flex-col items-center space-y-6">
        ...
        <a
          href="https://github.com/BeanyBB"
          target="_blank" // Opens the link in a new tab
          rel="noopener noreferrer" // Security best practice
          className="px-8 py-3 text-lg bg-gradient-to-r from-green-400 to-blue-600 hover:opacity-90 transition rounded-lg shadow-lg flex items-center justify-center space-x-3"
        >
